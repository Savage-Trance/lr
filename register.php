...
?>
	...
	<form action="" method="post">
		<ul>
			<li>
				Username:<font color='#B22222'>*</font><br>
				<input type="text" name="username">
			</li>
			<li>
				Password:<font color='#B22222'>*</font><br>
				<input type="password" name="password">
			</li>
			<li>
				Password again:<font color='#B22222'>*</font><br>
				<input type="password" name="password_again">
			</li>
			<li>
				First name:<font color='#B22222'>*</font><br>
			...
			<li>
				Email:<font color='#B22222'>*</font><br>
